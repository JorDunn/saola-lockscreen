...
## [0.3.0](https://github.com/JorDunn/saola-lockscreen/compare/saola-lockscreen-v0.2.0...saola-lockscreen-v0.3.0) - 2026-09-09

### Added

- *(config)* read lockscreen.toml instead of lockscreen.kdl

### Fixed

- *(reveal)* bound the Authenticating state and let Escape abandon a stalled attempt
...
- *(aur)* disable makepkg LTO — ring's C objects break the final link
